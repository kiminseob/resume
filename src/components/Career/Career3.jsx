            ...
            <ul>
              ...
              <SC.Wrapper>
                <SC.List>
                  ...
                  <SC.MarkerList>
                    ...
                    조건(출발지, 도착지, 날짜 등)을 자동으로 추출하는 프로세스를
                    설계
                  </SC.MarkerList>
                  <SC.MarkerList>
                    대화형 인터페이스 설계를 통해, 사용자의 추가 질문 및 조건
                    변경 요청을 유연하게 처리할 수 있는 검색 시스템 구축
                  </SC.MarkerList>
                  <SC.MarkerList>
              ...
              <SC.List>
                ...
                <SC.MarkerList>
                  <SC.Description>
                    ...
                    과정에서 접근성과 사용자 경험이 제한되었으며, 보다
                    직관적이고 편리한 대안이 필요했습니다. 이를 해결하기 위해 AI
                    스피커인 NUGU를 활용해, 실시간 항공권 검색 및 추천 서비스를
                    개발하게 되었습니다.
                  </SC.Description>
                </SC.MarkerList>
              </SC.List>
              <SC.List>
                ...
                <SC.MarkerList>
                  ...
                  지원하며, AI 스피커 기반 여행 서비스의 시장 진출을 선도
                </SC.MarkerList>
                <SC.MarkerList>
                  대화형 인터페이스 설계를 통해 사용자 경험을 크게 향상, 항공권
                  검색의 접근성과 편리성을 강화
                </SC.MarkerList>
                <SC.MarkerList>
                  대화형 항공권 검색 시스템 설계와 관련된 기술적 기여를 인정받아{' '}
                  <a href="#manuscript">KIICE 원고</a>에 설계 원고를 게재
                </SC.MarkerList>
              </SC.List>
            </ul>
          </SC.Row>
